document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- New Function to Load Values ---
    // Loads any saved values from localStorage into the input fields.
    ...
    function renderCommands() {
        let allHtml = '';
        // Assuming 'commandsData' is defined elsewhere in your project
    ...
    // Now saves the value to localStorage on every input change.
    ...
    renderCommands();
    updateAllCommandText(); // Then update the UI with the loaded (or default) values
});